...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.zordon \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/db52" \
       +incdir+"$ref_dir/../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/2527/hdl" \
       +incdir+"$ref_dir/../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/7e3a/hdl" \
       +incdir+"../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/db52" \
       +incdir+"../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/2527/hdl" \
       +incdir+"../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/7e3a/hdl" \
       +incdir+"../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/fb8f/hdl/verilog" \
       +incdir+"../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/f9cc/hdl/verilog" \
       +incdir+"../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/a07a/hdl/verilog" \
       +incdir+"../../../../magisterium.srcs/sources_1/bd/zordon/ipshared/8ef2/hdl/verilog" \
