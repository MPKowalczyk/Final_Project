...
HD_PWD='C:/Users/Marcin/VERILOG/test_rozmiar/hdmi_zybo_vga_axis_ps_vdma/hdmi_vga_zybo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_vga_vision_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source hdmi_vga_vision_wrapper.tcl -notrace
