...
HD_PWD='C:/Users/Marcin/VERILOG/magisterium_save/magisterium_save.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zordon_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zordon_wrapper.tcl -notrace
