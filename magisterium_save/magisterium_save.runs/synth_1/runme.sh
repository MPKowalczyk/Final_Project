...
HD_PWD='C:/Users/Marcin/VERILOG/magisterium_save/magisterium_save.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zordon_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zordon_wrapper.tcl
